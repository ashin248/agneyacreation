              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <label key={String(id)} onClick={() => setIsCompany(id)} className="flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all hover:bg-slate-50" style={{ borderColor: isCompany === id ? '#4f46e5' : '#f1f5f9' }}>
              ...
              <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-lg">
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="border-t border-white/10 pt-4">
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-2xl font-bold text-indigo-400">₹{totalPrice.toLocaleString('en-IN')}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    disabled={isUploading || files.length === 0}
                    className="w-full py-3 bg-indigo-600 text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:bg-indigo-500 transition-all disabled:opacity-50 active:scale-[0.98]"
                  >
                    {isUploading ? (
