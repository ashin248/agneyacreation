...
import {
  ...
  X, ShoppingBag, Loader2, Inbox, ChevronRight, Search
} from 'lucide-react';
    ...
    <div className="bg-white border border-slate-100 rounded-2xl p-4 flex items-center gap-4 hover:shadow-md hover:border-slate-200 transition-all duration-200 group">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1.5">
          ...
          <span className="text-[11px] text-slate-400">{orderDate}</span>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Track Orders</h1>
            <p className="text-sm text-slate-400 mt-1">Check the status of your orders</p>
          </div>
          {orders.length > 0 && (
            <button
              onClick={() => {
              ...
              className="text-xs font-semibold text-rose-500 bg-rose-50 px-3 py-2 rounded-xl border border-rose-100 hover:bg-rose-500 hover:text-white transition-all"
            >
              Clear History
            </button>
          )}
        ...
        {/* ── TABS ── */}
        <div className="flex gap-1.5 bg-slate-100 p-1.5 rounded-2xl mb-5">
          {TABS.map(tab => (
            <button
              key={tab}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-slate-100 shadow-sm">
            <Inbox size={36} className="text-slate-200 mb-4" strokeWidth={1.5} />
            <h3 className="text-sm font-bold text-slate-700">No orders in this tab</h3>
