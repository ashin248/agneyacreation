...
const OnboardingModal = ({ isOpen, onComplete }) => {
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-slate-950/80 backdrop-blur-3xl p-4 md:p-10 animate-in fade-in duration-500 overflow-y-auto">
            ...
            <div className="absolute top-[10%] left-[10%] w-[30%] h-[30%] blur-[150px] rounded-full pointer-events-none" style={{ background: 'rgba(74,95,212,0.12)' }}></div>
            <div className="absolute bottom-[10%] right-[10%] w-[30%] h-[30%] bg-sky-500/10 blur-[150px] rounded-full pointer-events-none"></div>
            ...
            <div className="w-full max-w-4xl bg-white/90 backdrop-blur-2xl rounded-[48px] shadow-2xl border border-white/50 overflow-hidden relative flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className="hidden md:flex md:w-1/3 bg-slate-950 p-12 flex-col justify-between relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-sky-500/10"></div>
                    ...
                    <div className="relative z-10 space-y-8">
                        <div className="flex items-center gap-4 group">
                            <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-indigo-400 group-hover:text-white transition-all" onMouseEnter={e => e.currentTarget.style.background='linear-gradient(135deg,#4A5FD4,#0EA5E9)'} onMouseLeave={e => e.currentTarget.style.background=''}>
                                <Smartphone size={18} />
                            </div>
                ...
                <div className="flex-1 p-8 md:p-14 overflow-y-auto custom-scrollbar">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <button
                            ...
                            style={{ background: 'linear-gradient(135deg,#4A5FD4 0%,#0EA5E9 100%)', boxShadow: '0 20px 40px rgba(74,95,212,0.3)' }}
                        >
                            {loading ? (
